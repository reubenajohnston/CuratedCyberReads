# Curated Cyber Reads
An open project with categorized, curated lists of cyber reads.  For updates, please either create a [pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request#creating-the-pull-request) or contact me via email with details.  All contributions will receive acknowledgement in corresponding documents.
